    ...
    <thead>
      <tr>
        ...
        <th colspan="7" class="border-b border-s-200 dark:border-g-700">
          <p class="py-0 font-normal text-xs text-g-500">Дата</p>
        </th>
      </tr>
      <tr>
        <th
        ...
        >
          <p class="font-normal text-xs text-g-500">Объект</p>
        </th>
        <th
          v-for="(day, index) in weekDays"
          :key="day.day"
          class="rowBody px-4 py-0.5 font-medium text-base border-r border-b border-s-200 dark:border-g-700"
          :class="[
        ...
        >
          ...
          >
            <div
              ...
              class="text-left text-g-900 dark:text-white"
            >
